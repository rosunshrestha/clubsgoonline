...
namespace clubsgoonline.Management
{
    public partial class RolesBasedAuthorization : System.Web.UI.Page
    {
        ...
        protected void UserGrid_RowCreated(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow && e.Row.RowIndex != UserGrid.EditIndex)
            {
                ...
                EditButton.Visible = (User.IsInRole("Administrator") || User.IsInRole("Moderator"));
